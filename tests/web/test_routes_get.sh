...
run_curl_body_contains_case "GET / includes web test scripts" GET "$TEST_WEB_BASE_URL/" 200 "tests/web/test_two.sh"
run_curl_case "GET /tests/agent/test_one.sh" GET "$TEST_WEB_BASE_URL/tests/agent/test_one.sh" 200 "$SCRIPT_BODY"
run_curl_case "GET /tests/..%2Fescape rejects invalid segment" GET "$TEST_WEB_BASE_URL/tests/..%2Fescape" 400 "invalid path"
...
run_curl_case "GET /tests/agent/not_a_file returns 404" GET "$TEST_WEB_BASE_URL/tests/agent/not_a_file" 404 "not found"
