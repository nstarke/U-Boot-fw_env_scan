...
run_curl_body_contains_case "GET / includes agent argument scripts" GET "$TEST_WEB_BASE_URL/" 200 "tests/agent/scripts/linux/test_linux_dmesg_args.ela"
...
run_curl_body_contains_case "GET /tests/agent/scripts/linux/test_linux_dmesg_args.ela" GET "$TEST_WEB_BASE_URL/tests/agent/scripts/linux/test_linux_dmesg_args.ela" 200 "linux dmesg"
...
run_curl_body_contains_case "GET /tests/agent/scripts/linux/test_linux_dmesg_args.ela falls back to repo tests dir" GET "http://127.0.0.1:5312/tests/agent/scripts/linux/test_linux_dmesg_args.ela" 200 "linux dmesg"
